...
extension String {
    ...
    fileprivate func refine(_ stringComponents: [String], _ refinedComponents: inout [String]) {
    ...
    fileprivate func parse(_ stringComponents: inout [String]) {
    ...
    func parseParentheticalString() -> [String] {
        ...
        parse(&stringComponents)

        var refinedComponents: [String] = []
        refine(stringComponents, &refinedComponents)
        // return the array
